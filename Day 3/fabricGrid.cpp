...
The goal is to determine how many square inches in the large fabric
are claimed by 2 or more of the rectangular region inputs.
...
int main() {
	...
	//increment count for each space in fabricGrid that has a value greater than 1
	for (int i = 0; i < 1000; i++) {
		for (int j = 0; j < 1000; j++) {
			if (fabricGrid.at(i).at(j) > 1) count++;
		}
	}
